        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductBrand>(entity =>
            {
                entity.HasKey(e => e.BrandId)
                    .HasName("PK__product___06B772B927925836");
            ...
            modelBuilder.Entity<ProductCategory>(entity =>
            {
                entity.HasKey(e => e.CatId)
                    .HasName("PK__product___17B6DD26362DC873");
            ...
            modelBuilder.Entity<ProductColour>(entity =>
            {
                entity.HasKey(e => e.ProdColorId)
                    .HasName("PK__product___20CD4C1B9F18DA98");
            ...
            modelBuilder.Entity<ProductImage>(entity =>
            {
                entity.HasKey(e => e.ProdImgId)
                    .HasName("PK__product___CA31B84A592E3DDE");
            ...
            modelBuilder.Entity<ProductSize>(entity =>
            {
                entity.HasKey(e => e.ProdsizeId)
                    .HasName("PK__product___250222401EA5F338");
            ...
            modelBuilder.Entity<ProductSubcategory>(entity =>
            {
                entity.HasKey(e => e.SubcatId)
                    .HasName("PK__product___B28CCD2CAB25F805");
            ...
            modelBuilder.Entity<ProductsInventory>(entity =>
            {
                entity.HasKey(e => e.ProdInvId)
                    .HasName("PK__products__F5B0A0ABA713F0D4");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.EmailAddress, "UQ__users__347C302760A50108")
                    .IsUnique();

                entity.HasIndex(e => e.MobileNo, "UQ__users__4D7970A83F673449")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserAddress>(entity =>
            {
                entity.HasKey(e => e.UserAddId)
                    .HasName("PK__user_Add__47A94CE9FE570DDC");
