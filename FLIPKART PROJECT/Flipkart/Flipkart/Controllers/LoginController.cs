...
namespace Flipkart.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        private User AuthenticateUser(LoginDTO login)
        {
            ...
            User availableuser = userservice.Get().Where(x => (x.EmailAddress == login.mobile_or_email || x.MobileNo == login.mobile_or_email) && x.Password.Trim() == loginpassword.Trim()).FirstOrDefault();
