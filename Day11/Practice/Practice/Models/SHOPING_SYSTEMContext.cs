...
namespace Practice.Models
{
    public partial class SHOPING_SYSTEMContext : DbContext
    {
        ...
        public virtual DbSet<OrderDetailDTO> OrderDetailDTO { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer(ConfigurationManager.ConnectionStrings["SHOPING_SYSTEM"].ConnectionString);
            }
        }
