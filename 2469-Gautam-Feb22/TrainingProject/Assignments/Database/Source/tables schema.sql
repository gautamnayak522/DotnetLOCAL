...
(
	...
	created_at datetime DEFAULT GETDATE(),
	modified_at datetime,
	CONSTRAINT FK_cartitems_cartID FOREIGN KEY(cartID) REFERENCES shoping_cart(cartID),
	CONSTRAINT FK_cartitems_productID FOREIGN KEY(productID) REFERENCES products(productID)
)
