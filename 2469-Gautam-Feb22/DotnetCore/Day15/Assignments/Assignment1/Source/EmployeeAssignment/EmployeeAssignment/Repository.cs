...
namespace EmployeeAssignment
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public EmployeeAssignmentsDBContext DBContext { get; set; }
        public Repository(EmployeeAssignmentsDBContext employeeAssignmentsDBContext)
        {
            DBContext = employeeAssignmentsDBContext;
        }
