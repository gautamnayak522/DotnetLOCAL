        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CompanySchem>(entity =>
            {
                entity.HasKey(e => e.SchemeId)
                    .HasName("PK__CompanyS__DB7E1A427425BBBF");
            ...
            modelBuilder.Entity<CustAddress>(entity =>
            {
                entity.HasKey(e => e.AddressId)
                    .HasName("PK__Cust_Add__091C2A1B0771F983");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasKey(e => e.CustId)
                    .HasName("PK__Customer__049E3A89630AD8FE");

                entity.HasIndex(e => e.CustEmail, "UQ__Customer__263FA28D11BE20B8")
                    .IsUnique();
            ...
            modelBuilder.Entity<OrderedItem>(entity =>
            {
                entity.HasKey(e => e.OrderItemId)
                    .HasName("PK__OrderedI__57ED06A1C5575A5B");
            ...
            modelBuilder.Entity<ToyCompany>(entity =>
            {
                entity.HasKey(e => e.PlantId)
                    .HasName("PK__ToyCompa__98FE395CD98EADE0");
